 ...
 * a soft "pop" every time the stroke connects a new tile. SoundPool (not
 * MediaPlayer) is the right tool here since it preloads the clip into
 * memory and plays it with near-zero latency, which matters for something
 * that can fire many times a second during a fast drag.
 *
